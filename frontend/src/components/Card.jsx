function Card({ icon, title, description }) {
  return (
    <div className="drop-shadow-lg h-24 w-full block md:w-64 md:h-44 px-5 py-4 m-2 md:flex md:flex-col rounded-2xl bg-neutral-700 transition-colors hover:bg-neutral-600">
